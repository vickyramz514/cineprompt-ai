...
const ENDPOINTS: EndpointDef[] = [
  ...
  },
  {
    ...
    method: "GET",
    label: "Batch prices",
    description: "Latest prices for comma-separated symbols",
    category: "Stocks",
  ...
  },
  {
    ...
    method: "GET",
    label: "ETF list",
    description: "Popular ETFs with prices",
    category: "ETF",
  },
  {
    path: "/options/:symbol",
    method: "GET",
    label: "Options chain",
    description: "Calls and puts for a symbol",
    category: "Options",
    premium: true,
    params: [{ key: "symbol", label: "Symbol", placeholder: "AAPL" }],
  },
  ...
  },
  {
    ...
    description: "Inflation, rates, GDP, unemployment",
    category: "Economy",
    premium: true,
  },
  {
    ...
    method: "GET",
    label: "Dark pool",
    description: "Off-exchange block trades",
    category: "Dark pool",
    premium: true,
    params: [{ key: "symbol", label: "Symbol", placeholder: "AAPL" }],
  },
