...
const RANGES: ChartRangeId[] = ["1D", "5D", "1M", "3M", "6M", "1Y", "5Y"];
...
export default function FeaturedMarket({ apiKey, snapshot, snapshotLoading }: Props) {
  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[minmax(0,7fr)_minmax(280px,3fr)]">
      <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-[#10101a] via-[#0c0c14] to-[#0a1220] p-4 backdrop-blur-md sm:p-5">
        ...
        <div className="relative mt-3 min-h-[360px]">
          ...
          {error ? (
            ...
            <CandlestickChart bars={bars} height={360} onCrosshair={setHover} />
          )}
        </div>
