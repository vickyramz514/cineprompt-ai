...
export default function DarkPoolIndexPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (s) router.push(`/dashboard/darkpool/${encodeURIComponent(s)}`);
  };

  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold">Dark Pool Trades</h1>
        <p className="mt-1 text-white/60">View dark pool activity for any symbol</p>
      </div>
