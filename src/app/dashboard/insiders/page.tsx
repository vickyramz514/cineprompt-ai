...
export default function InsidersIndexPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (s) router.push(`/dashboard/insiders/${encodeURIComponent(s)}`);
  };

  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-semibold">Insider Trades</h1>
        <p className="mt-1 text-white/60">View insider trading activity for any symbol</p>
      </div>
