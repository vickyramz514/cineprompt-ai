    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className={`relative overflow-hidden px-4 pb-24 sm:px-6 lg:px-8 ${SITE_HEADER_OFFSET}`}>
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          >
            Historical prices, screener, heatmap, rankings, backtests, and portfolio rebalance —
            one API key from Data Captain. Ship ETF tools in your product, not another browser tab.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="border-t border-white/5 px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          >
            Key features for ETF builders
          </motion.h2>
          <p className="mx-auto mt-3 max-w-2xl text-center text-white/55">
            Production-ready market data endpoints with clear schemas, API-key auth, and official SDKs.
          </p>
