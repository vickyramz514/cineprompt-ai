    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 lg:px-8">
        <div className="space-y-10">
          <div>
            <h1 className="text-2xl font-semibold sm:text-3xl">US ETF REST API documentation</h1>
            <p className="mt-2 text-white/60">
              Authenticate with an API key and call Data Captain endpoints for the ETF universe,
              batch prices, market status, screener, rankings, heatmap, backtesting, and portfolio tools.
              Official TypeScript and Python SDKs included below.
            </p>
          </div>
...
const rankings = await dc.etf.rankings({ category: "return", period: "1y" });`}
              ...
              <div className="rounded-xl border border-white/10 bg-black/30 p-4">
                ...
                <pre className="mt-2 overflow-x-auto text-sm">
                  <code className="text-emerald-400">pip install datacaptain</code>
                </pre>
                <pre className="mt-3 overflow-x-auto rounded-lg border border-white/10 bg-black/40 p-3 text-xs text-white/70">
...
rankings = dc.etf_screener(return_min=10, period="1y")`}
            ...
            <p className="mt-2 text-xs text-white/45">
              ...
              . Source in{" "}
              <code className="rounded bg-white/10 px-1">packages/datacaptain</code> and{" "}
              <code className="rounded bg-white/10 px-1">packages/datacaptain-python</code>.
            </p>
          </section>
